<template>
    <header class="flex flex-col md:flex-row sm:justify-between sm:mb-5 sm:p-5 align-end">
        <a class="logo-container ml-10 sm:ml-0 mt-24 sm:mt-0" href="/">
            <svg
                class="logo-pakebusch drop-shadow-md w-48 md:w-48"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 192 150"
            >
                <desc>Jana Pakebusch Physiotherapeutin</desc>
                <g>
                    <g>
                        <defs>
                            <path
				...
				l-0.09,0.13l-0.93,1.46L94.53,74.49z"
                        ...
                        >
                            ...
                            <stop offset="0.2334" style="stop-color: #a20f18" />
                            <stop offset="0.3719" style="stop-color: #a51720" />
                            <stop offset="0.4856" style="stop-color: #ab252e" />
                            <stop offset="0.5859" style="stop-color: #b23941" />
                            <stop offset="0.6774" style="stop-color: #bd535a" />
                            <stop offset="0.7625" style="stop-color: #c97479" />
                            <stop offset="0.8426" style="stop-color: #d89a9e" />
                            <stop offset="0.9187" style="stop-color: #e9c6c8" />
                            <stop offset="0.9893" style="stop-color: #fcf7f7" />
				...
				C99.75,63.94,100.36,63.97,101.55,63.51z"
                        ...
                        <rect
                            ...
                            y="50.8"
                            style="
                                clip-path: url(#SVGID_00000153666454778121878860000014789585623683161510_);
                                fill: #a10c16;
                            "
                            width="23.67"
                            height="23.67"
				...
				c0.81,0.25,1.62,0.43,2.43,0.5c6.2,0.39,11.45-4.81,15.05-4.67l0.3,0l3.28-0.06L107.54,49.22z"
                        ...
                        >
                            ...
                            <stop offset="0.0675" style="stop-color: #bf281f" />
                            <stop offset="0.4154" style="stop-color: #d78261" />
                            <stop offset="0.697" style="stop-color: #e8c0a9" />
                            <stop offset="0.8982" style="stop-color: #f2e6da" />
				...
				c-0.63-0.06-1.31-0.2-2-0.42C85.47,51.98,84.87,50.99,82.91,49.59z"
                        ...
                        <rect
                            ...
                            y="12.47"
                            style="
                                clip-path: url(#SVGID_00000139976988234001524280000000460019854644330666_);
                                fill: #c60d1f;
                            "
                            width="55.93"
                            height="55.93"
				...
				C111.75,54.92,111.46,53.52,109.76,51.07z"
                        ...
                        >
                            ...
                            <stop offset="0.2621" style="stop-color: #e46d27" />
                            <stop offset="0.5745" style="stop-color: #e97a1e" />
                            <stop offset="0.9114" style="stop-color: #f08e00" />
        ...
        <nav class="flex flex-row justify-center text-primary h-fit md:mt-24 gap-2 sm:gap-4 mx-2">
            <router-link to="/" class="nav-btn hidden lg:inline">Startseite</router-link>
            <router-link to="/Behandlungen" class="nav-btn">Behandlungen</router-link>
            <router-link to="/Preisliste" class="nav-btn">Preisliste</router-link>
            <router-link to="/Kontakt" class="nav-btn sm:mr-0">Kontakt</router-link>
        </nav>
    </header>
</template>
...
.router-link-active {
    background-image: linear-gradient(hsl(0, 0%, 100%), hsl(36.4, 100%, 89%)) !important;
    &:hover {
